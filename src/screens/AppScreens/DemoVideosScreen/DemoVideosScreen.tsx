    ...
    <View style={Styles.container} >
      ...
      <View style={Styles.wrapper} >
        ...
        <View style={Styles.header} >
          ...
          <Text style={Styles.headerBodyText} >Stream some of the videos to get a better idea about the app.</Text>
        </View>

        {/* videos */}
        {
          videos?.length <= 0 ?
            <WarningBanner warning='No new videos available!' message='Hold tight for upcoming video tutorials.' />
          :
            <ScrollView>
