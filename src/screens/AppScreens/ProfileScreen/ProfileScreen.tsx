        ...
        <View style={Styles.content} >
          ...
          <View style={Styles.contentBody} >
            ...
            <View style={Styles.documentContainer} >
              <MoreOptions>
                <MoreOptions.OptionTabs iconName='Document' optionName='Change Language' tabStyle={{ marginBottom: 0 }} />
              </MoreOptions>
            </View>
            <MoreOptions>
              <MoreOptions.OptionTabs iconName='Glob' optionName='Change Language' tabStyle={{ marginBottom: 20 }} />
              ...
              <MoreOptions.OptionTabs iconName='Bank' optionName='Add Bank' tabStyle={{ marginBottom: 20 }} />
