...
const services = [
	{
		...
		name: "Sahyadhri Hospital",
		tag: "Hospital",
		star: "4.8",
		reviews: "20,171",
		location:
			"H no. 8-2-601/p/15, Banjara Hills, Hyderabad, Telangana 500034",
	},
	{
		id: 2,
		image: require("../../../constants/image/Hospital2.png"),
		name: "Atithi Hospital",
		tag: "Rediology",
		star: "4.8",
		reviews: "20,171",
		location:
...
export default function ProfileScreen(): JSX.Element {
	...
	function onPressTab(index: number) {
		setSelctedTabIndex(index);
	}
