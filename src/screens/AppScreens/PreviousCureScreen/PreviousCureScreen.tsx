...
import { View, Text, StatusBar, ScrollView, ImageSourcePropType } from 'react-native';
    ...
    <View style={Styles.container} >
      ...
      <View style={Styles.wrapper} >
        ...
        <View style={Styles.header} >
          ...
          <Text style={Styles.headerBodyText} >List of Hospitals, taking care of our previous patients, cure patients with us.</Text>
        </View>
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={Styles.scroll} contentContainerStyle={Styles.scrollContainer} >
          {previousCures.map(item => (
            <PreviousCureCard key={item.id} onPressCard={onPressCard} item={item}  />
          ))}
        </ScrollView>
      </View>
      ...
      <View style={Styles.footer} >
        ...
        <PrimaryButton onPress={onPressReferCase} backgroundColor={AppStyles.colorBrand1} >
          Refer Case
        </PrimaryButton>
      </View>
    </View>
