...
export default function TieupCarouselComponent({ item }: TieupCarouselComponentPropsType): JSX.Element {
  return (
    <View style={Styles.container} >
      ...
      <View style={Styles.content} >
        ...
        <View style={Styles.locationContainer} >
          ...
          <Text numberOfLines={1} ellipsizeMode={'tail'} style={[Styles.reviewText, { width: '90%' }]} >{item.location}</Text>
        </View>
      </View>
    </View>
  )
