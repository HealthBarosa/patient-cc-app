...
export default function Coupon({ code, value, onPressApply, onPressReferPatient }: ICouponType): JSX.Element {
  return (
    <View style={Styles.container} >
      <Text style={Styles.headerText} >{code.toUpperCase()}</Text>
      <Text style={Styles.bodyText} >Tap to apply and get {value} discount</Text>
